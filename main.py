...
class Drawer:
    def __init__(self, parent, result):
        ...
        self.slave.geometry('500x500')
        self.slave.grab_set()
        self.slave.focus_set()
        self.canvas = Canvas(self.slave, width=500,height=500,bg='black')
        self.canvas.pack()
        self.canvas.create_line(250, 0, 250, 500,fill='white')
        self.canvas.create_line(0, 250, 500, 250,fill='white')
        self.canvas.create_oval(125,125,375, 375, outline='white', width=2)
        self.canvas.create_line(250, 250, 250+math.cos(result)*125, 250-math.sin(result)*125, fill='yellow', width=4)
